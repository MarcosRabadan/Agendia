...
namespace MRC.Agendia.Infrastructure.Migrations
{
    ...
    [Migration("20260818185935_OneDefaultScheduleTemplatePerBusiness")]
    partial class OneDefaultScheduleTemplatePerBusiness
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MRC.Agendia.Domain.Entities.ScheduleTemplate", b =>
                {
                    ...
                    b.HasIndex(new[] { "BusinessId" }, "IX_ScheduleTemplate_OneDefaultPerBusiness")
                        .IsUnique()
                        .HasFilter("\"IsDefault\"");
