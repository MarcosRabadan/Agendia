...
namespace MRC.Agendia.Domain.Interfaces
{
    public interface IScheduleTemplateRepository
    {
        ...
        Task<ScheduleTemplate?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default);
        ...
        Task<ScheduleTemplate?> GetByIdWithSlotsAsync(Guid id, CancellationToken cancellationToken = default);
        ...
        Task<IEnumerable<ScheduleTemplate>> GetByBusinessIdAsync(Guid businessId, CancellationToken cancellationToken = default);
        ...
        Task<ScheduleTemplate?> GetEffectiveTemplateAsync(Guid businessId, DateOnly date, CancellationToken cancellationToken = default);
        ...
        Task<bool> HasOverlappingTemplateAsync(Guid businessId,
                                               DateOnly from,
                                               DateOnly to,
                                               Guid? excludeId = null,
