namespace MRC.Agendia.Application.Appointments.DTO
{
    ...
    /// and what the agenda rules out for that date (closed day, full slot, time off). The full
    /// list of possible codes, and why it is open-ended, is in docs/error-codes.md.
    /// </summary>
