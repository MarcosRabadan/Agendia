...
> - **Formateo de firmas con 4+ parámetros (commit `9346154`):** ~30 declaraciones de método que estaban en una sola línea pasaron a multilínea (estilo del proyecto: salto tras `(`, un parámetro por línea a +4, `)` pegado al último param). **Solo whitespace** (verificado: contenido sin espacios idéntico a HEAD en los 24 ficheros).
