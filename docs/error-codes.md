...
| `SLOT_ON_HOLD` | `SlotOnHoldException` | La franja está reservada temporalmente para un cliente de la lista de espera (#268); nadie más puede cogerla hasta que expire el hold. |
